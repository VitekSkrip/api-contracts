...
const (
	...
	AuthService_GetAll_FullMethodName   = "/auth.AuthService/GetAll"
)
...
func (c *authServiceClient) GetAll(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
...
func (UnimplementedAuthServiceServer) GetAll(context.Context, *GetRequest) (*GetResponse, error) {
...
func _AuthService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetAll(ctx, req.(*GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
